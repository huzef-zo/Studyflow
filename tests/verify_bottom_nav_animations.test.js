...
assert(cssContent.includes('transition: color 0.35s cubic-bezier(0.34, 1.56, 0.64, 1)'), 'CSS nav item should sync color transition duration with indicator slide');
